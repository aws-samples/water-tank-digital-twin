...
export class IotCore extends Construct {
  ...
  createComponents(watertankName: string, virtual = true) {
    ...
    const components = [this.createComponent('amper_meter', {
          ...
          merge: JSON.stringify({
            "logsUploaderConfiguration": {
              ...
              "componentLogsConfiguration": [
                {
                  "componentName": "aws.prototyping.digital_twin.amper_meter",
                  "deleteLogFileAfterCloudUpload": "true",
                  "diskSpaceLimit": "10",
                  "diskSpaceLimitUnit": "MB",
                  "minimumLogLevel": "INFO"
                ...
                {
                  "componentName": "aws.prototyping.digital_twin.compute_status",
                  "deleteLogFileAfterCloudUpload": "true",
                  "diskSpaceLimit": "10",
                  "diskSpaceLimitUnit": "MB",
                  "minimumLogLevel": "INFO"
                ...
                {
                  "componentName": "aws.prototyping.digital_twin.flow_meter",
                  "deleteLogFileAfterCloudUpload": "true",
                  "diskSpaceLimit": "10",
                  "diskSpaceLimitUnit": "MB",
                  "minimumLogLevel": "INFO"
                ...
                {
                  "componentName": "aws.prototyping.digital_twin.lcd_manager",
                  "deleteLogFileAfterCloudUpload": "true",
                  "diskSpaceLimit": "10",
                  "diskSpaceLimitUnit": "MB",
                  "minimumLogLevel": "INFO"
                ...
                {
                  "componentName": "aws.prototyping.digital_twin.led_manager",
                  "deleteLogFileAfterCloudUpload": "true",
                  "diskSpaceLimit": "10",
                  "diskSpaceLimitUnit": "MB",
                  "minimumLogLevel": "INFO"
                ...
                {
                  "componentName": "aws.prototyping.digital_twin.ohms_meter",
                  "deleteLogFileAfterCloudUpload": "true",
                  "diskSpaceLimit": "10",
                  "diskSpaceLimitUnit": "MB",
                  "minimumLogLevel": "INFO"
                ...
                {
                  "componentName": "aws.prototyping.digital_twin.remote_control",
                  "deleteLogFileAfterCloudUpload": "true",
                  "diskSpaceLimit": "10",
                  "diskSpaceLimitUnit": "MB",
                  "minimumLogLevel": "INFO"
                ...
                {
                  "componentName": "aws.prototyping.digital_twin.serial_split",
                  "deleteLogFileAfterCloudUpload": "true",
                  "diskSpaceLimit": "10",
                  "diskSpaceLimitUnit": "MB",
                  "minimumLogLevel": "INFO"
                ...
                {
                  "componentName": "aws.prototyping.digital_twin.temperature",
                  "deleteLogFileAfterCloudUpload": "true",
                  "diskSpaceLimit": "10",
                  "diskSpaceLimitUnit": "MB",
                  "minimumLogLevel": "INFO"
                ...
                {
                  "componentName": "aws.prototyping.digital_twin.timestream_sync",
                  "deleteLogFileAfterCloudUpload": "true",
                  "diskSpaceLimit": "10",
                  "diskSpaceLimitUnit": "MB",
                  "minimumLogLevel": "INFO"
